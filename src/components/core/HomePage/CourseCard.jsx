...
const CourseCard = ({cardData,currentCard,onClick}) => {
  return (
    <div className={` w-[360px] lg:w-[30%] h-[300px] box-border cursor-pointer
     ...
     : "bg-richblack-800  text-richblack-25"} mb-12`} onClick={onClick}>

        <div className='flex flex-col p-6 border-b-[2px] border-richblack-400 border-dashed h-[80%]'>
